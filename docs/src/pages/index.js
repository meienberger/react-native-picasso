...

  {
    ...
    description: (
      <>
        ...
        places and integrate at your own pace.
      </>
    ),
  },
]
...
function Home() {
  ...
  return (
    <Layout
      ...
      description="Strong design system for your react native apps"
    >
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        <div className="container">
          <h1 className="hero__title">{siteConfig.title}</h1>
          <p className="hero__subtitle">{siteConfig.tagline}</p>
          <p>You should not think about your design once it's defined</p>
